...
export const userSettings = pgTable("user_settings", {
  ...
  scheduleMode: varchar("schedule_mode", { length: 20 }).notNull().default("fixed"),
  cycleWorkDays: varchar("cycle_work_days", { length: 10 }).notNull().default("6"),
  cycleRestDays: varchar("cycle_rest_days", { length: 10 }).notNull().default("1"),
